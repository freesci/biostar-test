...
python manage.py migrate wwwportalmlekozyjestart.server 0001 --fake
python manage.py migrate wwwportalmlekozyjestart.server 

echo "*** apply new ranking"
python -m wwwportalmlekozyjestart.bin.patch --reapply_ranks --update_domain
