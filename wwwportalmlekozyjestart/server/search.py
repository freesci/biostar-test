...
from wwwportalmlekozyjestart.server import html, const, formdef
from wwwportalmlekozyjestart.server.html import get_page
...
from wwwportalmlekozyjestart.server.models import Post
...
def initialize(sender=None, **kwargs):
    ...
    if sender.__name__ != 'wwwportalmlekozyjestart.server.models':
        return
...
def get_posts(flag=True):
    from wwwportalmlekozyjestart.server import models
