...
from wwwportalmlekozyjestart.server import html, models, auth, notegen, formdef
...
def user_edit(request, uid):
    ...
    if request.method == 'GET':
        ...
        if not form.is_valid():
            ...
            url = reverse('wwwportalmlekozyjestart.server.views.user_profile', kwargs=dict(uid=target.id))
            return html.redirect(url)
